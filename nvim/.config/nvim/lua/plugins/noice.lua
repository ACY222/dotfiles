return {
  ...
  -- It works well, but no auto-suggestions before I typing tab
  {
    ...
    keys = {
      -- so now we use ';n' as prefix
      -- dismiss all messages
      { ";d", function() require("noice").cmd("dismiss") end, desc = "Dismiss All" },
      -- show last message
      { ";l", function() require("noice").cmd("last") end, desc = "Noice Last Message" },
      -- show noice history
      { ";h", function() require("noice").cmd("history") end, desc = "Noice History" },
    },
