return {
    {
        ...
        keys = {
            -- File Explorer
            {
                ...
                desc = "Open Snakcks File Explorer",
            },
            {
                "<leader>rf",
                function()
            ...
            },
            {
                ...
                desc = "Find Files by Contents",
            },
            -- fuzzy searching documents
            {
                "<leader>hp",
                function()
            ...
            -- compare different colorschemes
            {
                "<leader>cs",
                function()
            ...
            },
            {
                ...
                desc = "Goto Definition", -- the function in .h
            },
            {
                "gr",
                function()
                ...
                nowait = true,
                desc = "References", -- the list about where we call the function
            },
            {
                "gi",
                function()
                ...
                desc = "Goto Implementation", -- the function in .cpp
            },
            {
                "gt",
                function()
